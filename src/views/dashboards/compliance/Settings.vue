...
const security = ref({ twoFactor: true, sessionTimeout: '30' })
</script>
          ...
          <div class="p-6">
            <div v-if="activeTab === 'profile'" class="space-y-6">
              <div class="flex items-center gap-5 pb-6 border-b border-[#e5e7eb]">
                <div class="w-16 h-16 bg-[#2D5A27] rounded-full flex items-center justify-center text-xl font-bold text-white">JN</div>
              ...
              <div class="grid grid-cols-2 gap-5">
                ...
                <div><label class="block text-[11px] font-medium text-[#6b7280] mb-1.5">Badge</label><input v-model="profile.badge" type="text" class="input-field" /></div>
                <div class="col-span-2"><label class="block text-[11px] font-medium text-[#6b7280] mb-1.5">Department</label><input v-model="profile.department" type="text" class="input-field" /></div>
              </div>
            ...
            <div v-if="activeTab === 'notifications'" class="space-y-0">
              <div class="flex items-center justify-between py-4 border-b border-[#e5e7eb]">
                <div><p class="text-sm font-medium text-[#1f2937]">Email Notifications</p><p class="text-xs text-[#9ca3af]">Case updates via email</p></div>
              ...
              <div class="flex items-center justify-between py-4">
                <div><p class="text-sm font-medium text-[#1f2937]">Push Notifications</p><p class="text-xs text-[#9ca3af]">Real-time alerts</p></div>
            ...
            <div v-if="activeTab === 'security'" class="space-y-6">
              <div class="flex items-center justify-between py-4 border-b border-[#e5e7eb]">
                <div><p class="text-sm font-medium text-[#1f2937]">Two-Factor Authentication</p><p class="text-xs text-[#9ca3af]">Mandatory for compliance officers</p></div>
