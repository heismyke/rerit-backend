...
const profile = ref({
  name: 'Chinedu Okafor',
  email: 'c.okafor@devcorp.ng',
  phone: '+234 801 234 5678',
  company: 'DevCorp Properties Ltd',
          ...
          <div class="p-6">
            <div v-if="activeTab === 'profile'" class="space-y-6">
              ...
              <div class="grid grid-cols-2 gap-5">
                <div>
                  <label class="block text-[11px] font-medium text-[#6b7280] mb-1.5">Full Name</label>
                  <input v-model="profile.name" type="text" class="input-field" />
                </div>
                <div>
                  <label class="block text-[11px] font-medium text-[#6b7280] mb-1.5">Email Address</label>
                  <input v-model="profile.email" type="email" class="input-field" />
                </div>
                <div>
                  <label class="block text-[11px] font-medium text-[#6b7280] mb-1.5">Phone Number</label>
                  <input v-model="profile.phone" type="text" class="input-field" />
                </div>
                <div>
                  <label class="block text-[11px] font-medium text-[#6b7280] mb-1.5">Company Name</label>
                ...
                <div class="col-span-2">
                  ...
                  <input v-model="profile.address" type="text" class="input-field" />
                </div>
              </div>
            ...
            <div v-if="activeTab === 'notifications'" class="space-y-0">
              <div class="flex items-center justify-between py-4 border-b border-[#e5e7eb]">
                <div>
                  <p class="text-sm font-medium text-[#1f2937]">Email Notifications</p>
              ...
              <div class="flex items-center justify-between py-4 border-b border-[#e5e7eb]">
                <div>
                  <p class="text-sm font-medium text-[#1f2937]">SMS Notifications</p>
              ...
              <div class="flex items-center justify-between py-4">
                <div>
                  <p class="text-sm font-medium text-[#1f2937]">Push Notifications</p>
            ...
            <div v-if="activeTab === 'security'" class="space-y-6">
              <div class="flex items-center justify-between py-4 border-b border-[#e5e7eb]">
                <div>
                  <p class="text-sm font-medium text-[#1f2937]">Two-Factor Authentication</p>
