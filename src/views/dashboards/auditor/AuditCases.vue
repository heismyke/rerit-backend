...
const auditCases = ref([
  ...
  { id: 'AUD-2024-003', property: '15 Admiralty Way, Lekki', owner: 'Chidi Okafor', auditor: 'John Smith', priority: 'Low', status: 'Completed', started: '2024-01-05', due: '2024-01-20', resultStatus: 'Compliant', resultNotes: 'Filing verified. No discrepancies found.', resultSentAt: '2024-01-19' },
  { id: 'AUD-2024-004', property: 'Plot 8, Banana Island', owner: 'Folake Adeyemi', auditor: 'Michael Brown', priority: 'Critical', status: 'Flagged', started: '2024-01-08', due: '2024-01-22', resultStatus: 'Non-Compliant', resultNotes: 'Under-declared rental income. Notice of non-compliance issued.', resultSentAt: '2024-01-18' },
])
